-- IN-GAME TEST ONLY: examples/10-text.lua with every T node removed and nothing else changed.
-- The pair measures what text labels cost a scene that rebuilds: same shapes, same data,
-- same tick. Not shipped.
